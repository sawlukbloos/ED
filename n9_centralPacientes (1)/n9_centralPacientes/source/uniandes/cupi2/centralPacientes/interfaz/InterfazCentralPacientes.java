...
public class InterfazCentralPacientes extends JFrame
{
     ...
     * @param formaAdicion La forma en la que se va realizar la adición del paciente (de primero, ultimo, antes de otro pacientes o despues de otro paciente). formaAdicion
     *        pertenece a {ANTES, DESPUES, COMIENZO, FINAL}
     * @param codPaciente El código del paciente antes del cual se va a insertar el nuevo paciente
     * @param elCodigo La cédula del paciente - elCodigo>0
     * @param elNombre El nombre del paciente - elNombre!=null && elNombre!=""
     * @param laClinica La clínica del paciente - laClinica!=null && laClinica!=""
     * @param laHistoriaClinica la historia clínica del paciente - laHistoriaClinica!=null && laHistoriaClinica!=""
     * @param elSexo El sexo del paciente.
     * @throws NoExisteException Si el código del paciente con relación al cual se va a realizar la adición no se encuentra registrado
     * @throws YaExisteException
     * @throws YaExisteException Si ya existe un paciente con el código que se le va a asignar al nuevo paciente
     */
